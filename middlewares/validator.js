...
exports.employeeValidation = [
  ...
  check('employee_type', 'Employee type must be salary, hourly, private_duty_nurse, or supervisor').isIn(['salary', 'hourly', 'private_duty_nurse', 'supervisor']),
...
exports.employeeUpdateValidation = [
  ...
  check('email', 'Please include a valid email').optional().isEmail(),
  check('employee_type', 'Employee type must be salary, hourly, private_duty_nurse, or supervisor').optional().isIn(['salary', 'hourly', 'private_duty_nurse', 'supervisor']),
